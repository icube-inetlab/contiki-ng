This example is a copy of the generic hello-world example from Contiki-NG,
whith a project-conf.h file that sets debug confgurations
and also adds the module SHELL in the Makefile.
...
```
make TARGET=efr32tb BOARD=stk GECKO_SDK_PATH=$HOME/path/to/gecko/v2.2
```
